...
void main() async {
  ...
  runApp(
    DevicePreview(
      ...
      tools: const [
        CustomPlugin(
          apkDownloadUrl: "https://github.com/Harshit2756/flutter_google_clone/releases/download/v1.0.0/app-release.apk", 
          sourceCodeUrl: "https://github.com/Harshit2756/flutter_google_clone/archive/refs/tags/v1.0.0.zip",
        ),
        DeviceSection(
